...
public class ServletProcessor1 {
    ...
    public static Servlet loadServlet(String servletName) throws MalformedURLException {
    ...
    public static void callService(Servlet servlet, ServletRequest request,
